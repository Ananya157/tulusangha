import ExecutiveBoardJson from '../../assets/committeeData/executiveBoard.json'
...
export const ExecutiveBoard = () => {
    return (
        <div>
            <h1 className="homeHeader marginBorder newsletter">Founder Committee 2021-23: Executive Board</h1>
            <List
                itemLayout="vertical"
                size="large"
                dataSource={ExecutiveBoardJson}
                renderItem={item => (
                    <List.Item
                        key={item.title}
